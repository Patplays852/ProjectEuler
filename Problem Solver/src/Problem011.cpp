	...
	for (int col = 0; col <= 19; col++){
		...
		for (int row = 0; row <= 16; row++){
			...
			for (int i = 0; i <= 3; i++){
				...
				if(i + row > 19){cout << "you broke it" << endl;break;} //debug line
...
int Problem011::Horizontal(){
	...
	for (int row = 0; row <= 19; row++){
		...
		for (int col = 0; col <= 16; col++){
			...
			for (int i = 0; i <= 3; i++){
				//takes the first 4 index's of the row.
				if(i + col > 19){cout << "you broke it" << endl;break;} //debug line
...
int Problem011::Diagional(){
	...
	for (int row = 0; row <= 16; row++){
        for(int col = 0; col <= 16; col++){
            ...
            for (int i = 1; i <= 3; i++){
                if(i+col > 19 || i+row > 19){cout << "you broke it" << endl;break;} //debug line
	...
	for (int row = 4; row <= 16; row++){
        for(int col = 4; col <= 19; col++){
            ...
            for (int i = 0; i <= 3; i++){
                if(row - i < 0 || col - i < 0){cout << "you broke it" << endl;break;} //debug line
...
void Problem011::Solve(){
	...
	cout << endl << endl << to_string(re) << endl;
}
