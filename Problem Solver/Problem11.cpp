...
long long Problem11::Verticle(){
	long long prod = 0;

	for (long long col = 0; col <= 19; col++){
		//itterate through each column array[row][column]
		for (long long row = 0; col <= 16; row++){
...
long long Problem11::Horizontal(){
	long long prod = 0;
